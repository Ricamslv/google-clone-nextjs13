...
export default function HomeSearch() {
    ...
    return (
       ...
       hover:shadow-md focus-within:shadow-mid transition-shadow sm:max-w-xl lg:max-2xl">
            <AiOutlineSearch className="text-x1 text-gray-500 mr-3" />
            <input 
            type="text" 
       ...
       mt-8">
           ...
           <button disable={randomSearchLoading} onClick={randomSearch} className="btn flex items-center justify-center
           disabled:opacity-80">
           {randomSearchLoading ? (
               <img 
               src="spinner.svg" 
